...
This project provides a complete schema for all Pure Storage FlashArray GET endpoints return objects using the marshmallow schema.

This schema can help parse and easily use the objects returned by the Pure Storage Python SDK.
